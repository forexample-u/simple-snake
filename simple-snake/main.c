...
#define UseAnsi 0 //Work on ansi windows 10 юбилейной серии и дальше и почти любой unix... Но windows 7, 8, 8.1 и 10 до серии не работает, для них нужен макрос 0
#if UseAnsi
    ...
    while (1) {
        ...
        while (1) { //Algorithm
            ...
            if (x != old_x || y != old_y) {
                ...
                //Save Life Snake
                if (die_snake == 0) { die_casual_bounce = 0; }
                if (die_snake == 1) {
